...
public class SimEvent implements Cloneable, Comparable<SimEvent> {
	...
	public String toString() {
		return "Event type = " + getEventTypeName() + " Event tag = " + CloudSimTags.ToString(tag) + " Event time = " + time + " source = " + CloudSim.getEntity(entSrc).getName() + " destination = "
