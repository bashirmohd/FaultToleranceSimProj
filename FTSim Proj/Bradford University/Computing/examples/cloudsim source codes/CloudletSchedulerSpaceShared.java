...
public class CloudletSchedulerSpaceShared extends CloudletScheduler {
	...
	public double cloudletResume(int cloudletId) {
		...
		if (found) {
			...
			if ((currentCpus - usedPes) >= rcl.getNumberOfPes()) {
				//Log.printLine("[CloudletSchedulerSpaceShared.cloudletResume] from (currentCpus - usedPes) >= rcl.getNumberOfPes() : Cloudrgl.getRemainingCloudletLength() " + rcl.getRemainingCloudletLength());
